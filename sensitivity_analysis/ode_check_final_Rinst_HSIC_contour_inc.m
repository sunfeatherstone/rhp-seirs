...
pdfName = sprintf('rho_contour_%s_inst.pdf', city);
...
exportgraphics(fig,'HSIC_grouped_bar_Rinst.pdf', ...
               'ContentType','vector','BackgroundColor','none');
...
function Ri = floquet_multiplier(theta20, F_hour, dt)
% ------------------------------------------------------------
...
% ------------------------------------------------------------
% ------------------------------------------------------------
% sup_{t∈[0,168h]} R_inst(t)
% 参数同 floquet_multiplier；默认 dt = 0.05 h
% ------------------------------------------------------------
