...
lb_num=-7;
un_num=+3;
lb_p   = [lb_num;lb_num;lb_num;lb_num;lb_num;lb_num;lb_num;log(0.1);-3;-3];     % A1…A11
ub_p   = [un_num;un_num;un_num;un_num;un_num;un_num;un_num;log(12);+3;+3];
D      = numel(lb_p);
...
stateF            = 'cma_state_local_new_chengdu.mat';
if isfile(stateF)
