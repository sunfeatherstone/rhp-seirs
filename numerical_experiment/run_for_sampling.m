...
POOL_FILE   = 'numerical_experiment/param_pool.csv';
RESULT_FILE = 'numerical_experiment/sampling_results.csv';
CHUNK       = 10;               
dt_hr       = 0.5;
T_period_hr = 168;
burnin      = 5;
...
if isfile(RESULT_FILE)
    ...
    hdr = ['paramID,flag,periodLen,steps'];
...
function [flag,periodLen,nSteps] = simulate( ...
